package com.example.lesson54_firestoreapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    private DocumentReference friendRef = db
            .collection("Users")
            .document("Friends");
...
//        data.put(KEY_EMAIL,email);
    ...
    // 1- Saving Data on Firestore (Creating Data)              [DONE]
    // 2- Reading Data from Firestore (Retrieving Data)         [DONE]
...
//
//        friendRef.addSnapshotListener(this,
