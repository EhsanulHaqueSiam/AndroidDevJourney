package com.example.lesson33_gamesapp;
...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        int currentPosition = holder.getAdapterPosition(); // Use 'currentPosition' instead of 'position'
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(context, "You choose: " + gamesList.get(currentPosition).getGameName(), Toast.LENGTH_SHORT).show();
            }
        });
    }
